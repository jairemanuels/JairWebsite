...
<body class="max-w-screen px-1">
  ...
  <div class="absolute left-0 top-0 z-10 sm:z-50 w-full">
    ...
    <section class="mt-32">
      ...
      <p class="text-l text-center mt-8">
      ...
      <div class="text-center mt-6 flex justify-center gap-2">
        ...
        <a class="group inline-flex items-center justify-center rounded-full py-2 px-4 text-sm font-semibold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 bg-slate-900 text-white hover:bg-slate-700 hover:text-slate-100 active:bg-slate-800 active:text-slate-300 focus-visible:outline-slate-900" variant="solid" color="slate" href="https://www.youtube.com/@JairEmanuels?sub_confirmation=1" target="_blank"><svg class="h-5 sm:mr-2" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 461.001 461.001" xml:space="preserve">
            <g>
  ...
  <section class="mt-62">
    <div class="h-64 mt-64"></div>
    <?php
    include "sections/Video.php";
    ?>
  </section>

  <!-- <iframe src="https://www.subbb.me/jair" style="width:100%; height:100vh;"></iframe> -->
